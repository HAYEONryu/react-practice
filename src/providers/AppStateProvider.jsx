...
const AppStateProvider = ({ children }) => {
    //useState는 컴포넌트에서 state값을 추가할때 사용된다
    ...
    return (
        //Provider를 통해 value에 상태를 담아주고, children을 선언하여 Provider 내부의 컴포넌트를 대상으로 생성된 컨텍스트를 언제든 사용할 수 있도록 만들어줍니다. 
        //즉, children에 해당되는 컴포넌트는 컨텍스트를 사용할 수 있는 단계가 됨
